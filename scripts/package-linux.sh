...
stage_server() {
  ...
  install -m 0644 docs/QUICKSTART.md docs/DOCTOR.md docs/LITE_PROFILE.md docs/LITE_INSTALL.md docs/LITE_CONFIG.md docs/LITE_BACKUP_RESTORE.md docs/PRODUCTION_CHECKLIST.md docs/RELEASE_CHECK.md docs/PRODUCTION_READINESS_GATE.md docs/PRODUCTION_EVIDENCE.md docs/RELEASE_READINESS_MATRIX.md docs/SECURITY_MODEL.md docs/THREAT_MODEL.md docs/API_COMPATIBILITY_POLICY.md docs/SECURITY_HARDENING_FINAL_REVIEW.md docs/BARE_METAL_FULL_INSTALL.md docs/KUBERNETES_BOOTSTRAP_MATERIAL.md docs/OPERATIONAL_READINESS_SMOKE.md "$stage/usr/share/doc/custodia/"
