...
require_file "${PREFIX#/}/share/custodia/sdk/clients/node/package.json"
require_file "${PREFIX#/}/share/custodia/sdk/clients/node/src/index.js"
require_file "${PREFIX#/}/share/custodia/sdk/clients/node/src/index.d.ts"
require_file "${PREFIX#/}/share/custodia/sdk/clients/node/examples/keyspace_transport.mjs"
require_file "${PREFIX#/}/share/custodia/sdk/clients/node/examples/high_level_crypto.mjs"
require_file "${PREFIX#/}/share/custodia/sdk/clients/java/pom.xml"
require_file "${PREFIX#/}/share/custodia/sdk/clients/java/src/main/java/dev/custodia/client/CustodiaClient.java"
require_file "${PREFIX#/}/share/custodia/sdk/clients/java/examples/KeyspaceTransportExample.java"
require_file "${PREFIX#/}/share/custodia/sdk/clients/java/examples/HighLevelCryptoExample.java"
...
require_file "${PREFIX#/}/share/custodia/sdk/testdata/client-crypto/manifest.json"
require_file "${PREFIX#/}/share/custodia/sdk/testdata/client-crypto/README.md"
require_file "${PREFIX#/}/share/custodia/sdk/testdata/client-crypto/v1/create_secret_single_recipient.json"
require_file "${PREFIX#/}/share/custodia/sdk/testdata/client-crypto/v1/wrong_recipient_fails.json"
