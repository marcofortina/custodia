...
- Packaged a `custodia-signer.service` alongside `custodia.service` so first-run Lite installs can issue additional client mTLS certificates without manually inventing signer startup flags.
