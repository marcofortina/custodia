...
| Kubernetes + Full | Target production cluster path. Requires external database/HA, real secrets management, PKCS#11/HSM or audited signer integration, WORM/SIEM evidence, governed ingress/gateway exposure and NetworkPolicy evidence. |
